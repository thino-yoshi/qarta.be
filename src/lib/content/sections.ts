...
export const SECTION_DEFS: SectionDef[] = [
...

  {
    ...
    fields: [
      ...
      { key: "subtitle", label: "Paragraphe",             type: "textarea",  defaultValue: "Un univers pensé pour faire disparaître les cartes en papier et créer, d'un seul geste, un lien durable entre les clients et les commerçants." },
...

  {
    ...
    fields: [
      ...
      { key: "subtitle",    label: "Paragraphe",             type: "textarea",  defaultValue: "Fini les cartes cartonnées froissées au fond du portefeuille. Toutes vos cartes de fidélité, instantanément réunies, organisées, et prêtes à l'emploi." },
      { key: "featureLabels", label: "Fonctionnalités (4 pilules)", type: "list-text", defaultValue: ["QR code unique", "Apple & Google Wallet", "Récompenses auto", "Vos commerces préférés"] },
    ],
  },
